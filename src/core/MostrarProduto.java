...
public class MostrarProduto {
    ...
    public MostrarProduto(int id, String titulo, String preco, String descricao, String categoria, String estado, Date dataupload, String fotografia) {
        this.id = id;
        this.titulo = titulo;
        this.preco = preco;
    ...
    public boolean equals(Object obj) {
        ...
        final MostrarProduto other = (MostrarProduto) obj;
        if (this.id != other.id) {
            return false;
        }
    ...
    public String toString() {
        return "MostrarProduto{" + "id=" + id + ", titulo=" + titulo + ", preco=" + preco + ", descricao=" + descricao + ", categoria=" + categoria + ", estado=" + estado + ", dataupload=" + dataupload + ", fotografia=" + fotografia + '}';
    }
